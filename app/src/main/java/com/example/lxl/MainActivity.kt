...
class MainActivity : AppCompatActivity(),
    ...
    fun ShowPicture() {
        /*
        when (PictureNo) {
            0 -> img.setImageResource(R.drawable.xl0)
            1 -> img.setImageResource(R.drawable.xl1)
            2 -> img.setImageResource(R.drawable.xl2)
            3 -> img.setImageResource(R.drawable.xl3)
        }
        */
        txv.text = PictureNo.toString()
        var res:Int = getResources().getIdentifier("xl" + PictureNo.toString(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        while (res != 0) {
            countDrawables++;
            res = getResources().getIdentifier("xl" + countDrawables.toString(),
                "drawable", getPackageName());
        }
